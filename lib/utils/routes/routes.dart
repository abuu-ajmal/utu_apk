...
import 'package:assetmanag/view/auth/login_form.dart';
import 'package:assetmanag/view/auth/login_views.dart';
import 'package:assetmanag/view/challenge_module/add_challenge.dart';
import 'package:assetmanag/view/challenge_module/challenge.dart';
...
class Routes {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RoutesName.newChallenge:
        return MaterialPageRoute(builder: (context) => const Challenge());
      ...
      case RoutesName.registration:
        return MaterialPageRoute(builder: (context) => const FormRegistration());
